...
logfile = None
logging.basicConfig(format=format, level=logging.DEBUG, datefmt="%H:%M:%S", filename=logfile)
...
ssh_credentials = {
    "my_ssh_wildcard": {"ip_expression": "*.*.*.*", "user": "abcd", "password": "test", "enable_password": "test"}
}
devices = [
    {
